...
function Register() {
    ...
    return (
        <form onSubmit={handleSubmit}>
            <h3>Register</h3>
            <input placeholder="Full Name" onChange={e => setForm({ ...form, name: e.target.value })} /><br />
            <input placeholder="Account Number" onChange={e => setForm({ ...form, account: e.target.value })} /><br />
